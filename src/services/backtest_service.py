...
class BacktestRequest:
    """Data class for backtest requests"""
    def __init__(
        self,
        ticker: str,
        strategy: str,
...
class BacktestResponse:
    """Data class for backtest responses"""
    def __init__(
        self,
        success: bool,
        ticker: str,
...
class BacktestService:
    ...
    Orchestrates strategy loading, parameter setup, and backtest execution.
    """
    ...
    def run_backtest(request: BacktestRequest) -> BacktestResponse:
        ...
        Args:
            request: BacktestRequest containing all backtest parameters
        ...
        if request.start_date:
            ...
            start_date = datetime.now().date() - relativedelta(
                years=Config.DEFAULT_BACKTEST_PERIOD_YEARS
            )
